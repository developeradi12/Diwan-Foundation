      ...
      <SidebarContent>
        <SidebarGroup className="space-y-2">
          ...
          <SidebarMenuItem className="text-white ">
            <SidebarMenuButton>
              <Link href="/donor/dashboard" className="flex gap-2 items-center bg-green-950 px-3 py-4 !rounded-lg w-full ">
                <div className="">
          ...
          <SidebarMenuItem className="text-white ">
            <SidebarMenuButton>
              <Link href="/donor/id" className="flex gap-2 items-center hover:bg-green-950 px-3 py-4 rounded-md w-full ">
                <div className="">                 

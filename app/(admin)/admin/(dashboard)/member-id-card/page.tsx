...
const IdCardPage = () => {
  const [certificates, setCertificates] = useState<IdCard[]>([]);
  ...
  const handleDelete = async () => {
    ...
    setIsDeleting(true);
    try {
      await api.delete(`/id-card/${certificateToDelete}`);
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-sm mt-0.5 text-gray-400">
              Manage and publish all members ID cards
            </p>
          </div>
          <Button
                    ...
                    <TableCell colSpan={4} className="text-center py-16">
                      <div className="flex flex-col items-center gap-2">
                        <RefreshCw
                          ...
                          style={{ color: "var(--color-primary)" }}
                        />
                        <p className="text-sm text-gray-400">Fetching ID cards...</p>
                      </div>
                    </TableCell>
                  </TableRow>
                ) : paginated.length === 0 ? (
                    ...
                    <TableCell colSpan={4} className="text-center py-16">
                      <div className="flex flex-col items-center gap-2">
                        ...
                        <p className="text-sm font-medium" style={{ color: "var(--color-primary)" }}>
                          {debouncedSearch ? "No results found" : "No ID cards found"}
                        </p>
                        <p className="text-xs text-gray-400">
                          {debouncedSearch
                            ? "Try a different search term"
                            : "Generate your first ID card to get started"}
                        </p>
                      </div>
                    </TableCell>
                  </TableRow>

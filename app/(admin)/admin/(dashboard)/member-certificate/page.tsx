...
const MemberCertificate = () => {
  ...
  const handleDelete = async () => {
    ...
    setIsDeleting(true);
    try {
      await api.delete(`/certificate/${certificateToDelete}`);
  ...
  return (
    <div>
      <Header
        ...
        pageName="Dashboard"
        currentPage="Member Certificates"
      />
      ...
      <DeleteConfirmDialog
        ...
        description={`This action cannot be undone. The certificate will be permanently
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-sm mt-0.5 text-gray-400">
              Manage and publish all members certificate
            </p>
          </div>
          <Button
            onClick={() => router.push("/admin/member-certificate/generate")}
